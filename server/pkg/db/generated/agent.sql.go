...
RETURNING t.id, t.agent_id, t.issue_id, t.status, t.priority, t.dispatched_at, t.started_at, t.completed_at, t.result, t.error, t.created_at, t.context, t.runtime_id, t.session_id, t.work_dir, t.trigger_comment_id, t.chat_session_id, t.autopilot_run_id, t.attempt, t.max_attempts, t.parent_task_id, t.failure_reason, t.trigger_summary, t.force_fresh_session, t.is_leader_task, t.wait_reason, t.resume_at
`
...
SELECT atq.id, atq.agent_id, atq.issue_id, atq.status, atq.priority, atq.dispatched_at, atq.started_at, atq.completed_at, atq.result, atq.error, atq.created_at, atq.context, atq.runtime_id, atq.session_id, atq.work_dir, atq.trigger_comment_id, atq.chat_session_id, atq.autopilot_run_id, atq.attempt, atq.max_attempts, atq.parent_task_id, atq.failure_reason, atq.trigger_summary, atq.force_fresh_session, atq.is_leader_task, atq.wait_reason, atq.resume_at FROM agent_task_queue atq
...
const setAgentTaskResumeAt = `-- name: SetAgentTaskResumeAt :exec
UPDATE agent_task_queue
SET resume_at = $2
WHERE id = $1 AND status = 'failed'
`

type SetAgentTaskResumeAtParams struct {
	ID       pgtype.UUID        `json:"id"`
...
func (q *Queries) SetAgentTaskResumeAt(ctx context.Context, arg SetAgentTaskResumeAtParams) error {
	_, err := q.db.Exec(ctx, setAgentTaskResumeAt, arg.ID, arg.ResumeAt)
	return err
}
