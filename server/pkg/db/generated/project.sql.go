...
INSERT INTO project (
    ...
    $1, $2, $3, $4, $5, $6, $7, $8, COALESCE($9::jsonb, '{}'::jsonb)
) RETURNING id, workspace_id, title, description, icon, status, lead_type, lead_id, created_at, updated_at, priority, quality_gate_config
`
...
SELECT id, workspace_id, title, description, icon, status, lead_type, lead_id, created_at, updated_at, priority, quality_gate_config FROM project
WHERE id = $1
`
...
UPDATE project SET
    ...
    lead_type = $7,
    lead_id = $8,
    quality_gate_config = COALESCE($9::jsonb, quality_gate_config),
    updated_at = now()
WHERE id = $1
RETURNING id, workspace_id, title, description, icon, status, lead_type, lead_id, created_at, updated_at, priority, quality_gate_config
`
